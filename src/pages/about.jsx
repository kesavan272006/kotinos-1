...
function About() {
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className=" head left flex items-center justify-center md:text-6xl text-3xl py-5 gap-5 bg-white">
                <h1 className='russo pt-3'>About Us</h1>
            </div>
            <br />
            <div className=" flex flex-col items-center justify-center mx-10 my-5 font-sans">
                <h1 className='text-4xl russo'>Your <span className='text-[#2BCEE0]'>Future</span>. Our <span className='text-[#2BCEE0]'>Technology</span>. One <span className='text-[#2BCEE0]'>Vision</span>.</h1>
