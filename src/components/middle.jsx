                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <div style={{
                        ...
                        <button
                            ...
                            onMouseEnter={() => gsap.to('.underline-events', { width: '100%', duration: 0.3 })}
                            onMouseLeave={() => gsap.to('.underline-events', { width: showevents ? '100%' : '0%', duration: 0.3 })}
                            onClick={() => handleShowEvents()}
                            style={{
                                padding: '10px 20px',
                                color: showevents ? 'black' : 'gray',
                                fontWeight: showevents ? 'bold' : 'normal',
                        ...
                        >
                            <p className='hover:text-gray-900'>View Events</p>
                            <div className="underline-events" style={{
                                position: 'absolute',
                                bottom: '-2px',
                                left: 0,
                                width: showevents ? '100%' : '0%',
                                height: '3px',
                        ...
                        <button
                            className="tab-button" 
                            onMouseEnter={() => gsap.to('.underline-posts', { width: '100%', duration: 0.3 })}
                            onMouseLeave={() => gsap.to('.underline-posts', { width: showPosts ? '100%' : '0%', duration: 0.3 })}
                            onClick={() => handleShowPosts()}
                            style={{
                                padding: '10px 20px',
                                color: showPosts ? 'black' : 'gray',
                                fontWeight: showPosts ? 'bold' : 'normal',
                                backgroundColor: 'transparent',
                                border: 'none',
                                cursor: 'pointer',
                                position: 'relative',
                        ...
                        >
                            <p className='hover:text-gray-900'>View All Posts</p>
                            <div className="underline-posts" style={{
                                position: 'absolute',
                                bottom: '-2px',
                                left: 0,
                                width: showPosts ? '100%' : '0%',
                                height: '3px',
                                backgroundColor: 'blue',
                                transition: 'width 0.3s ease-in-out',
                            }}></div>
                        ...
                        <button
                            className="tab-button"
                            onMouseEnter={() => gsap.to('.underline-live', { width: '100%', duration: 0.3 })}
                            onMouseLeave={() => gsap.to('.underline-live', { width: showLive ? '100%' : '0%', duration: 0.3 })}
                            onClick={() => handleShowLive()}
                            style={{
                                padding: '10px 20px',
                                color: showLive ? 'black' : 'gray',
                                fontWeight: showLive ? 'bold' : 'normal',
                                backgroundColor: 'transparent',
                                border: 'none',
                                cursor: 'pointer',
                                position: 'relative',
                        ...
                        >
                            <p className='hover:text-gray-900'>View Live</p>
                            <div className="underline-live" style={{
                                position: 'absolute',
                                bottom: '-2px',
                                left: 0,
                                width: showLive ? '100%' : '0%',
                                height: '3px',
                                backgroundColor: 'blue',
                                transition: 'width 0.3s ease-in-out',
                            }}></div>
