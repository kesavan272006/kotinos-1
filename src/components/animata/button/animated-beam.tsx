  ...
  return (
    <div
      ...
      style={{
        ...
        // Use CSS custom property with type assertion
        ...({"--delay": `${index * 0.5}s`} as React.CSSProperties)
      }}
    >
      <div
        style={{
...
function Background() {
  ...
  return (
    <div
      ref={containerRef}
      className="absolute inset-0 flex h-[100vh] w-full flex-row justify-between bg-[#0A0F38]"
    >
      <div
        style={{
          background:
