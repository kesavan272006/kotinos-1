    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className=" flex flex-col items-center justify-center mx-10 my-5 font-sans">
                <h1 className='text-4xl russo'>Your <span className='text-[#2BCEE0]'>Team</span>. Our <span className='text-[#2BCEE0]'>Technology</span> One <span className='text-[#2BCEE0]'>Vision</span>.</h1>
