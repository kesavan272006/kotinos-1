...
const Signin = () => {
    ...
    return (
        <div>
            ...
            {/* <img src={logo} className='logo md:block m-3 md:h-14 md:w-14 hidden rounded-full absolute mt-5' /> */}
            <div class="bg-image w-full"></div>
